...
This branch is the source code for the upcoming paper _Performance comparison of data-driven reduced models for a single-injector combustion process_ by Jain, Kramer, and McQuarrie.
